...
class loggingCallback(keras.callbacks.Callback):
    def on_epoch_end(self, epoch, logs=None):
        ...
        cr = classification_report(actual, predict, output_dict = True)
...
with mlflow.start_run(run_name="tumour") as run:
    ...
    """
model.fit(images_data, masks_data, epochs = 4, batch_size = 2, validation_split=0.1, callbacks=[loggingCallback()])
# 
